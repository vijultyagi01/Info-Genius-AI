...
os.environ["OPENAI_API_KEY"] = "sk-proj-bMqITGAiPuYqvOVFPA9YX5PCI61HgLosNxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"

# ✅ Check if API Key is set correctly
if not os.getenv("OPENAI_API_KEY"):
    raise ValueError("OpenAI API Key not found. Please check your key.")
